...
def eval_seq(seq, pp='', split='train', mcmt_cfg=None):
    ...
    results = associate(results, 0.2, 10, seq)
    ...
    results = track_nms(results, 0.65)  # 参数调大
...
if __name__ == '__main__':
    import sys
    print('sys args ars: ', "aic_mcmt.yml")
    cfg.merge_from_file(f'../../../../config/aic_mcmt.yml')
    cfg.freeze()
    eval_seq('c041', pp='pp', mcmt_cfg=cfg)
