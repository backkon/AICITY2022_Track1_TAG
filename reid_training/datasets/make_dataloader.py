...
from .aic_sim_aic22 import AIC_SIM_AIC22
...
def make_dataloader(cfg):
    ...
    if 'triplet' in cfg.DATALOADER.SAMPLER:
        if cfg.MODEL.DIST_TRAIN:
            ...
            logger.info('cfg.SOLVER.IMS_PER_BATCH: {}, world_size: {}'.format(cfg.SOLVER.IMS_PER_BATCH, dist.get_world_size()))
...
def make_dataloader_Pseudo(cfg):
    ...
    logger.info('using size :{} for training'.format(cfg.INPUT.SIZE_TRAIN))
